...
Usage (from repo root):
    python train_tdmpc.py task=walker-walk seed=1
    python train_tdmpc.py task=cheetah-run exp_name=myrun eval_freq=10000

Kaggle setup:
    !git clone <your-repo-url>
    %cd <repo-name>
    !pip install torch dm-control gym omegaconf termcolor pandas
    !python train_tdmpc.py task=walker-walk
